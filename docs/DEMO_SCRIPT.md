...
| 2:30 | Readiness figure and the new constraint in the list. | "Sixteen tools on document.modelContext plus that form — same origin, no API keys. What the agent may do alone is registered in code. What needs my hand is a form." |
